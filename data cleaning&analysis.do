//change working directory to suit your environment
cd "C:\Zhuofei Lu\OneDrive\Research\UKTUS2014_2015"

//data can be downloaded from the UK data service
...
act1_1-act1_144 othact1_1-othact1_144 enj1-enj144 dnssec8 DM016 DM014 ind_wt Income DVAge WrkLoc EducCur Happy Anxious SatSoc SatJob Satis LongIll GenHlth KindOfDay WorkSta ddayw
...
//drop strange cases (conflict choice) '4 deleted'
...
//final check before regression (exclude missing regarding flextime)
...
//table 3
//model 1
reg pwork_time i.type##i.class i.DMSex  i.child c.DVAge c.loghinc c.GenHlth [pw=ind_wt]
...
//table 4
//model 1
reg pwork_time i.type##i.class  i.child c.DVAge c.loghinc c.GenHlth if DMSex ==1 [pw=ind_wt]
